...
const challenges = [
    {
        number: 1,
        name: "#1 Write a Palindrome function",
        instructions: [
            "A palindrome is a word that is spelled the same way forward and backwards.",
            "In this challenge you are to write a function that will accept a string as a parameter",
            "and will check if that string is a palindrome.  If the string is a palindrome the",
            "function should return true otherwise return false.",
            "A string is a palindrome regardless of case or punctuation."
        ],
        seed: {
            code: [
